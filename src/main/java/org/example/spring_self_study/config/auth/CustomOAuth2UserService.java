...
import org.example.spring_self_study.config.auth.dto.OAuthAttributes;
import org.example.spring_self_study.config.auth.dto.SessionUser;
import org.example.spring_self_study.domain.user.User;
import org.example.spring_self_study.domain.user.UserRepository;
